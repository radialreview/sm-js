...
export declare type ChildrenQueryBuilderOpts<TTargetNode extends ISMNode> = {
    map: MapFnForNode<TTargetNode>;
    filter?: ValidFilterForNode<TTargetNode>;
    pagination?: ISMQueryPagination;
};
export interface IChildrenQueryBuilder<TTargetNode extends ISMNode> {
    <TQueryBuilderOpts extends ChildrenQueryBuilderOpts<TTargetNode>>(opts: TQueryBuilderOpts): IChildrenQuery<TTargetNode, TQueryBuilderOpts>;
}
export interface IChildrenQuery<TTargetNode extends ISMNode, TQueryBuilderOpts extends ChildrenQueryBuilderOpts<TTargetNode>> {
...
declare type ExtractQueriedDataFromChildrenQuery<TChildrenQuery extends IChildrenQuery<any, any>> = TChildrenQuery extends IChildrenQuery<infer TSMNode, infer TQueryBuilderOpts> ? Array<ExtractQueriedDataFromMapFn<TQueryBuilderOpts['map'], TSMNode>> : never;
