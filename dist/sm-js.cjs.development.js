...
var DO_PROXY_GENERATOR_ESCAPED_KEYS = ['nodeType', 'toJSON', '$$typeof', 'constructor', '@@__IMMUTABLE_ITERABLE__@@', '@@__IMMUTABLE_RECORD__@@', '_isMockFunction', 'asymmetricMatch', 'isMobXAtom', 'isMobXReaction']; // In the doProxyGenerator.spec.ts file, we use the .toMatchInlineSnapshot() function to test results. .toMatchInlineSnapshot adds DO_PROXY_GENERATOR_ESCAPED_KEYS as a key to
