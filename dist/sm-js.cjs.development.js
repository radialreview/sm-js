...
(function (SM_RELATIONAL_TYPES) {
  SM_RELATIONAL_TYPES["oneToOne"] = "oTO";
  SM_RELATIONAL_TYPES["oneToMany"] = "otM";
...
var oneToOne = function oneToOne(def) {
  return function (queryBuilderOpts) {
    return {
      ...
      _smRelational: exports.SM_RELATIONAL_TYPES.oneToOne,
...
var oneToMany = function oneToMany(def) {
  return function (queryBuilderOpts) {
    return {
      def: def,
      _relationshipName: queryBuilderOpts._relationshipName,
      _smRelational: exports.SM_RELATIONAL_TYPES.oneToMany,
      queryBuilderOpts: queryBuilderOpts
    };
  };
};
...
function getRelationalQueries(opts) {
  ...
  var relationalQueries = Object.keys(mapFnReturn).reduce(function (acc, alias) {
    var isData = !!opts.smData[alias];
    var isComputed = opts.smComputed ? !!opts.smComputed[alias] : false;
    ...
    if (isData || isComputed) {
      ...
      var addRelationalQueryRecord = function addRelationalQueryRecord(queryRecord) {
        ...
        if (relationalType === exports.SM_RELATIONAL_TYPES.oneToOne) {
          relationalQueryRecord.oneToOne = true;
        } else if (relationalType === exports.SM_RELATIONAL_TYPES.oneToMany) {
      ...
      if (relationalQuery._smRelational === exports.SM_RELATIONAL_TYPES.oneToOne || relationalQuery._smRelational === exports.SM_RELATIONAL_TYPES.oneToMany) {
