...
function getFlattenedSubscriptionFilter(opts) {
  ...
  var _loop = function _loop(filteredProperty) {
    ...
    var filterIsTargettingNestedObjectOrRelationalData = isObject(filterValue) && isObjectInNodeData;
  ...
  var _loop2 = function _loop2(filteredProperty) {
    ...
    if (typeof filterValue == 'object' && filterValue !== null && filterIsTargettingNestedObjectOrRelationalData) {
      ...
      if (isObject(filterValue)) {
        ...
        result[filteredProperty] = (_result$filteredPrope2 = {}, _result$filteredPrope2[EStringFilterOperator.eq] = filterValue, _result$filteredPrope2.condition = 'and', _result$filteredPrope2);
      }
    }
  };
