...
function getKeyValueArrayFilterString(filter) {
  var convertedToDotFormat = prepareObjectForBE(filter, {
    omitObjectIdentifier: true
  });
  return "[" + Object.entries(convertedToDotFormat).reduce(function (acc, _ref2, idx) {
    var key = _ref2[0],
        value = _ref2[1];
...
function getRelationalQueryString(opts) {
  return Object.keys(opts.relationalQueryRecord).reduce(function (acc, alias) {
    ...
    if ('byReference' in relationalQueryRecordEntry) {
      ...
      var filterString = 'filter' in relationalQueryRecordEntry && relationalQueryRecordEntry.filter !== undefined ? ",filter: " + getKeyValueArrayFilterString(relationalQueryRecordEntry.filter) : '';
