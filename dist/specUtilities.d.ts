...
import { SMJS } from '.';
import { IOneToOneQueryBuilder, IOneToManyQueryBuilder, ISMNode, ISMJS, ISMData, SMDataDefaultFn, NodeRelationalQueryBuilderRecord, NodeMutationFn, NodeComputedFns, NodeRelationalFns, SMConfig, SMNodeDefaultProps } from './types';
...
export declare type UserNode = ISMNode<'user', UserProperties, {
    displayName: string;
}, UserRelationalData, {}>;
