...
import { IDOProxy, Maybe, IMMGQL, QueryRecord, BaseQueryRecordEntry, RelationalQueryRecordEntry, QueryRecordEntry, RelationalQueryRecord, IQueryPagination, QueryDefinitions } from '../types';
...
export declare function createQueryManager(mmGQLInstance: IMMGQL): {
    new (queryDefinitions: QueryDefinitions<any, any, any>, opts: QueryManagerOpts): {
